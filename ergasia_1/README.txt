Υλοποιηση μιας βασης δεδομενων σε γλωσσα προγραμματισμου C.Η υλοποιηση βασιζεται στη δομη επεκτατου κατακερματισμου και υποστηριζει και δευτερευοντα ευρετηρια!

Μέλη Ομάδας:
	Τσαλαπάτης Αλέξανδρος
	Κοντός Αναστάσιος 
